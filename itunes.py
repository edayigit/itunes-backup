...
class IntegratedApp(TkinterDnD.Tk):  # TkinterDnD.Tk'yi kullanıyoruz
    def __init__(self):
        ...
        icon_path = "C:/Users/edayi_mxuaz17/OneDrive/Masaüstü/ITunes_logo.svg.png"
        ...
        # Add a file icon
        file_icon_path = "C:/Users/edayi_mxuaz17/OneDrive/Masaüstü/folder_icon.png"
    ...
    def connect_to_db(self):
        ...
        try:
            self.conn = sqlite3.connect("C:/Users/edayi_mxuaz17/OneDrive/Masaüstü/Manifest.db")
    ...
    def reset_treeview(self):
        """Reset the treeview to show all items."""
        for item_id in self.tree.get_children():
            self.tree.item(item_id, tags=())
            for child_id in self.tree.get_children(item_id):
                self.tree.item(child_id, tags=())
